...
//)
 ...
 lazy val core = (project in file("core"))
   .settings(
     commonSettings,
     name := "schema-core",
         libraryDependencies ++= Seq(shapeless, enumeratum, cats, refined,
           scalacheck % Test, scalatest % Test)
   )

 lazy val circe = (project in file("circe"))
   .dependsOn(core, scalacheckLib % Test)
   .settings(
     commonSettings,
     name := "schema-circe",
 ...
 lazy val http4s = (project in file("http4s"))
   ...
   .settings(
     commonSettings,
     name := "schema-http4s",
     libraryDependencies ++= Seq(http4sLib,
       scalacheck % Test, scalatest % Test)
   )
 ...
 lazy val scalacheckLib = (project in file("scalacheck"))
   ...
   .settings(
     commonSettings,
     name := "schema-scalacheck",
     libraryDependencies ++= Seq(
       scalacheck, scalatest % Test)
   )
